...
RCT_EXPORT_METHOD(computeAccountNameHash:(NSString *)accountName resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject){
    if ([self stringIsEmpty:accountName] ) {
        reject(@"0",@"accountName not null",nil);
    }else{
        NSError * error = nil;
        NSString *result = Zecrey_legendComputeAccountNameHash(accountName, &error);
        if (result) {
            resolve(result);
        }else{
            reject(@"0",error.localizedDescription,nil);
...
RCT_EXPORT_METHOD(generateEddsaKey:(NSString *)seed resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject){
    if ([self stringIsEmpty:seed] ) {
        reject(@"0",@"seed not null",nil);
    }else{
        NSString *result = Zecrey_legendGenerateEddsaKey(seed);
        if (result) {
            resolve(result);
        }else{
            reject(@"0",@"ComputeAccountNameHash error",nil);
        }
    }
}

RCT_EXPORT_METHOD(getAccountNameHash:(NSString *)accountName resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject){
    if ([self stringIsEmpty:accountName] ) {
        reject(@"0",@"accountName not null",nil);
    }else{
            NSError * error = nil;
        NSString *result = Zecrey_legendGetAccountNameHash(accountName, &error);
        if (result) {
            resolve(result);
        }else{
            reject(@"0",error.localizedDescription,nil);
...
RCT_EXPORT_METHOD(getEddsaPublicKey:(NSString *)seed resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject){
    if ([self stringIsEmpty:seed] ) {
        reject(@"0",@"seed not null",nil);
    }else{
        NSString *result = Zecrey_legendGetEddsaPublicKey(seed);
        if (result) {
            resolve(result);
        }else{
            reject(@"0",@"Zecrey_legendGetEddsaPublicKey not null",nil);
        }
    }
}

RCT_EXPORT_METHOD(keccakHash:(NSData *)value resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject){
    if ([self stringIsEmpty:value] ) {
        reject(@"0",@"value not null",nil);
    }else{
        NSData *result = Zecrey_legendKeccakHash(value);
        if (result) {
            resolve(result);
        }else{
            reject(@"0",@"keccakHash error",nil);
        }
    }
}

RCT_EXPORT_METHOD(signAddLiquidity:(NSString *)seed segmentInfo:(NSString *)segmentInfo resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject){
    if ([self stringIsEmpty:seed] ) {
        reject(@"0",@"seed not null",nil);
    }else{
        NSError * error = nil;
        NSString *result = Zecrey_legendSignAddLiquidity(seed, segmentInfo,  &error);
        if (result) {
            resolve(result);
        }else{
            reject(@"0",error.localizedDescription,nil);
...
RCT_EXPORT_METHOD(signAtomicMatch:(NSString *)seed segmentInfo:(NSString *)segmentInfo resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject){
    if ([self stringIsEmpty:seed] ) {
        reject(@"0",@"seed not null",nil);
    }else{
        NSError * error = nil;
        NSString *result = Zecrey_legendSignAtomicMatch(seed, segmentInfo,  &error);
        if (result) {
            resolve(result);
        }else{
            reject(@"0",error.localizedDescription,nil);
...
RCT_EXPORT_METHOD(signCancelOffer:(NSString *)seed segmentInfo:(NSString *)segmentInfo resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject){
    if ([self stringIsEmpty:seed] ) {
        reject(@"0",@"seed not null",nil);
    }else{
        NSError * error = nil;
        NSString *result = Zecrey_legendSignCancelOffer(seed, segmentInfo,  &error);
        if (result) {
            resolve(result);
        }else{
            reject(@"0",error.localizedDescription,nil);
...
RCT_EXPORT_METHOD(signCreateCollection:(NSString *)seed segmentInfo:(NSString *)segmentInfo resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject){
    if ([self stringIsEmpty:seed] ) {
        reject(@"0",@"seed not null",nil);
    }else{
        NSError * error = nil;
        NSString *result = Zecrey_legendSignCreateCollection(seed, segmentInfo,  &error);
        if (result) {
            resolve(result);
        }else{
            reject(@"0",error.localizedDescription,nil);
...
RCT_EXPORT_METHOD(signMintNft:(NSString *)seed segmentInfo:(NSString *)segmentInfo resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject){
    if ([self stringIsEmpty:seed] ) {
        reject(@"0",@"seed not null",nil);
    }else{
        NSError * error = nil;
        NSString *result = Zecrey_legendSignMintNft(seed, segmentInfo,  &error);
        if (result) {
            resolve(result);
        }else{
            reject(@"0",error.localizedDescription,nil);
...
RCT_EXPORT_METHOD(signOffer:(NSString *)seed segmentInfo:(NSString *)segmentInfo resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject){
    if ([self stringIsEmpty:seed] ) {
        reject(@"0",@"seed not null",nil);
    }else{
        NSError * error = nil;
        NSString *result = Zecrey_legendSignOffer(seed, segmentInfo,  &error);
        if (result) {
            resolve(result);
        }else{
            reject(@"0",error.localizedDescription,nil);
...
RCT_EXPORT_METHOD(signRemoveLiquidity:(NSString *)seed segmentInfo:(NSString *)segmentInfo resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject){
    if ([self stringIsEmpty:seed] ) {
        reject(@"0",@"seed not null",nil);
    }else{
        NSError * error = nil;
        NSString *result = Zecrey_legendSignRemoveLiquidity(seed, segmentInfo,  &error);
        if (result) {
            resolve(result);
        }else{
            reject(@"0",error.localizedDescription,nil);
...
RCT_EXPORT_METHOD(signSwap:(NSString *)seed segmentInfo:(NSString *)segmentInfo resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject){
    if ([self stringIsEmpty:seed] ) {
        reject(@"0",@"seed not null",nil);
    }else{
        NSError * error = nil;
        NSString *result = Zecrey_legendSignSwap(seed, segmentInfo,  &error);
        if (result) {
            resolve(result);
        }else{
            reject(@"0",error.localizedDescription,nil);
...
RCT_EXPORT_METHOD(signTransfer:(NSString *)seed segmentInfo:(NSString *)segmentInfo resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject){
    if ([self stringIsEmpty:seed] ) {
        reject(@"0",@"seed not null",nil);
    }else{
        NSError * error = nil;
        NSString *result = Zecrey_legendSignTransfer(seed, segmentInfo,  &error);
        if (result) {
            resolve(result);
        }else{
            reject(@"0",error.localizedDescription,nil);
...
RCT_EXPORT_METHOD(signTransferNft:(NSString *)seed segmentInfo:(NSString *)segmentInfo resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject){
    if ([self stringIsEmpty:seed] ) {
        reject(@"0",@"seed not null",nil);
    }else{
        NSError * error = nil;
        NSString *result = Zecrey_legendSignTransferNft(seed, segmentInfo,  &error);
        if (result) {
            resolve(result);
        }else{
            reject(@"0",error.localizedDescription,nil);
...
RCT_EXPORT_METHOD(signWithdraw:(NSString *)seed segmentInfo:(NSString *)segmentInfo resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject){
    if ([self stringIsEmpty:seed] ) {
        reject(@"0",@"seed not null",nil);
    }else{
        NSError * error = nil;
        NSString *result = Zecrey_legendSignWithdraw(seed, segmentInfo,  &error);
        if (result) {
            resolve(result);
        }else{
            reject(@"0",error.localizedDescription,nil);
...
RCT_EXPORT_METHOD(signWithdrawNft:(NSString *)seed segmentInfo:(NSString *)segmentInfo resolver:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject){
    if ([self stringIsEmpty:seed] ) {
        reject(@"0",@"seed not null",nil);
    }else{
        NSError * error = nil;
        NSString *result = Zecrey_legendSignWithdrawNft(seed, segmentInfo,  &error);
        if (result) {
            resolve(result);
        }else{
            reject(@"0",error.localizedDescription,nil);
